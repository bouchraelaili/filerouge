        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: black;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ADD NEW Activity</a>
                </div>
            ...
            <div class="container-fluid" >
                ...
                <div class="row">
                    <div class="col-md-8" >
                        <div class="card">
                            <div class="header">
                               <center><h4 class="title" >Activity Add Form</h4></center> 
                            </div>
                            <div class="content">
                                <form method="post" action="food_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category" class="form-control" required >
													...
													<option value="30min Surfing">30min Surfing</option>
													<option value="1h Camel Riding">1h Camel Riding</option>
													<option value="1h Jet Skiying">1h Jet Skiyingr</option>
                                                    <option value="1 jump sky diving">1 jump sky diving</option>
                                                    <option value="1h rock climbing">1h rock climbing</option>
                                                    <option value="30min carting">30min carting</option>
                                                    <option value="Tajine cooking class">Tajine cooking class</option>
                                                    <option value="Full day on the super Yakht">Full day on the super Yakht</option>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333">Activity Name</label>
                                                <input type="text" autofocus name="name" class="form-control" placeholder="Enter Activity Name" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" id="price" class="form-control" placeholder="Enter Activity Price" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtarea" class="form-control" placeholder="Enter Activity description" name="desc" required></textarea>
                                            </div>
                                        </div>
                                    </div>
									...
									<center>
                                    <input type="submit" name="submit" style="background: black; border: 1px solid black" value="Save Activity" class="btn btn-info btn-fill" />
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <?php echo strftime("%Y", time())?> <a href="index.php" style="color:black">LaMirage</a>
                </p>
            </div>
        </footer>
