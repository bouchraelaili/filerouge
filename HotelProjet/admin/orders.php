                        ...
                        <div class="card">
							...
							<div class="row">
								...
								<div class="col-md-12" >
									...
									<div class="col-md-3" style="text-align: center; background: black; color: #fff; border-right: 1px solid #fff;">
									
										<h5>ORDER ID</h5>
										
									</div>
									
									<div class="col-md-9" style="background: black; color: #fff;">
