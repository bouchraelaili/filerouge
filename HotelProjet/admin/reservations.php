<?php 
	...
	$per_page = 20;
		...
		if($reserve->num_rows) {
			...
			$result = "<p style='color:red; padding: 10px; background: #ffeeee;'>No reservations available yet</p>";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: black;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ROOM RESERVATIONS</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; 2020 <a href="index.php" style="color: black;">LaMirage</a>
                </p>
            </div>
        </footer>
